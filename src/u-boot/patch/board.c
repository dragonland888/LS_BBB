...
#else
#define LS_BBB_NAME     "A335BNLT"
#define LS_BBB_VERSION  "000B"
#define LS_BBB_SERIAL   "011600000001"
#define LS_BBB_CONFIG   "00000000000000000000000000000000"
#define LS_BBB_MAC_ADDR "00:0c:29:34:cc:6b"

    header.magic = 0xEE3355AA;
    strncpy(header.name,LS_BBB_NAME,HDR_NAME_LEN);
    strncpy(header.version,LS_BBB_VERSION,4);
    strncpy(header.serial,LS_BBB_SERIAL,12);
    strncpy(header.config,LS_BBB_CONFIG,32);
    strncpy(header.mac_addr,LS_BBB_MAC_ADDR,HDR_NO_OF_MAC_ADDR*HDR_ETH_ALEN);
#endif
...
void s_init(void)
{
	...
	if (board_is_evm_sk())
		...
		config_ddr(400, MT41K256M16HA125E_IOCTRL_VALUE,
			   ...
			   &ddr3_beagleblack_emif_reg_data, 0);//MD TBD: to be changed for hynix 256MB ddr
